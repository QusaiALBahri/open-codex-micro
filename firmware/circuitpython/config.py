...
JOYSTICK_LEFT = (Keycode.CONTROL, Keycode.ALT, Keycode.LEFT)
JOYSTICK_RIGHT = (Keycode.CONTROL, Keycode.ALT, Keycode.RIGHT)
JOYSTICK_UP = (Keycode.CONTROL, Keycode.ALT, Keycode.UP)
JOYSTICK_DOWN = (Keycode.CONTROL, Keycode.ALT, Keycode.DOWN)
JOYSTICK_DEADZONE = 12000
JOYSTICK_REPEAT_SECONDS = 0.12
